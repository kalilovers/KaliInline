...
local json = (loadfile "/root/inline/JSON.lua")()
local token = '363983180:AAHOI-NwvPU_zx9Ddh68vgBP0efKtVNeI3Y' --token
local url = 'https://api.telegram.org/bot' .. token
local offset = 0
local redis = require('redis')
local redis = redis.connect('127.0.0.1', 6379)
local SUDO = 358945323
        ...
        for i=1, #updates.result do
          ...
          if msg.inline_query then
            local q = msg.inline_query
						if q.from.id == 281426583 or q.from.id == 358945323 then
    ...
    return false
              ...
              local keyboard = {}
							keyboard.inline_keyboard = {
								{
                 {text = '🌀تنظیمات گروه🌀', callback_data = 'groupsettings:'..chat} --,{text = '💵Sales💵', callback_data = 'aboute:'..chat}
                },{
				...
				{text = '🔅راهنما🔅', callback_data = 'helptext:'..chat}
                 ...
                 {text = '🔅پشتیبانی و شارژ👀', callback_data = 'supportbot:'..chat} --,{text = '📝Your Adds📝', callback_data = 'youradds:'..chat} 
                },{
				{text = 'بستن پنل🚫', callback_data = 'close:'..chat}
				}
							}
            answer(q.id,'پنل','تنظیمات گروه',chat,'💠منو اصلی💠 :',keyboard)
            end
            end
						end
...
local hash = SUDO..'settings:'..chat..':'..value
 if redis:get(hash) then
    ...
    return false
            ...
            edit(q.inline_message_id,'🌀 منو اصلی 🌀 :',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                  {text = '🛠پشتیبانی🛠', callback_data = 'teamfani:'..chat},{text = '📝شارژ ربات📝', callback_data = 'enteqadvapishnehad:'..chat}
                },{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat}
				}
							}
              edit(q.inline_message_id,'👇بخش پشتیبانی و شارژ',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙بازگشت', callback_data = 'supportbot:'..chat}
				}
							}
              edit(q.inline_message_id,'[🔖پیام خود را ارسال کنید🔖](https://telegram.me/telin_teambot)',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[☑️Send Your Problem☑️](https://telegram.me/telin_teambot)',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙بازگشت', callback_data = 'fahedsale:'..chat}
				}
							}
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'[❗️برای شارژ پیام دهید❗️](https://telegram.me/telin_teambot)',keyboard)
            end
							------------------------------------------------------------------------
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙 بازگشت', callback_data = 'helpbot:'..chat}
				}
							}
		...
		local keyboard = {}
                   ...
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'groupinfo:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'managerlist:'..chat}
				}
							}
              edit(q.inline_message_id,'`⛔️Sorry, currently the system of choice is disabled⛔️`',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'ownerlist:'..chat}
				}
							}
              edit(q.inline_message_id,'`⛔️Sorry, currently the system of choice is disabled⛔️`',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'banlist:'..chat}
				}
							}
              edit(q.inline_message_id,'`⛔️Sorry, currently the system of choice is disabled⛔️`',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'silentlistusers:'..chat}
				}
							}
              edit(q.inline_message_id,'`⛔️Sorry, currently the system of choice is disabled⛔️`',keyboard)
            end
		...
		local keyboard = {}
				 ...
				 {text = '❌خیر❌', callback_data = 'as12310fklfkmgfvm:'..chat},{text = '✅بله✅', callback_data = '3kj5g34ky6g34uy:'..chat}
                   ...
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'showrules:'..chat}
				}
							}
              edit(q.inline_message_id,'⚜️آیا از انجام این عملیات مطمین هستید❓',keyboard)
            end
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'linkgroup:'..chat}
				}
							}
		...
		local keyboard = {}
				 ...
				 {text = '❌خیر❌', callback_data = 'ncxvbcusxsokd9374uid:'..chat},{text = '✅بله✅', callback_data = 'erewigfuwebiebfjdskfbdsugf:'..chat}
                   ...
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'filterlistword:'..chat}
				}
							}
              edit(q.inline_message_id,'⚜️آیا از انجام این عملیات مطمین هستید❓',keyboard)
            end
		...
		local keyboard = {}
				...
				{text = 'مدیریت حرفه ای گروه', callback_data = 'herfeiimanage:'..chat}
                   ...
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '🔙 برگشت به منوی قبلی💠', callback_data = 'fahedsale:'..chat}
				}
							}
		...
		local keyboard = {}
                   ...
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙 Back', callback_data = 'salegroup:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙 Back', callback_data = 'promanage:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙 Back', callback_data = 'normalmanage:'..chat}
				}
							}
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = '🔙 بازگشت به منو', callback_data = 'firstmenu:'..chat},{text = '🔙 Back', callback_data = 'herfeiimanage:'..chat}
				}
							}
                ...
                {text=getsettings('photo'),callback_data=chat..':lock photo'}, {text = '⬅️ تصاویر 🌆', callback_data = chat..'_photo'}
                 ...
                 {text=getsettings('username'),callback_data=chat..':lock username'}, {text = '⬅️ یوزنیم 🆔', callback_data = chat..'_username'}
                  ...
                  {text=getsettings('contact'),callback_data=chat..':lock contact'},{text = '⬅️ مخاطب 📞', callback_data = chat..'_contact'}
                   ...
                   {text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat},{text = '⬅️ صفحه دوم ', callback_data = 'next_page:'..chat}
                }
              }
         ...
         {text=getsettings('warn'),callback_data=chat..':lock warn'}, {text = '⬅️ عملکرد اخطار 💠', callback_data = chat..'_warn'}
          ...
          {text='⬇️',callback_data=chat..':lock WARNMAXdown'},{text='⬆️',callback_data=chat..':lock WARNMAXup'}
                 ...
                 {text = '↗️حداکثر تعداد اسپم↘️ : '..tostring(MSG_MAX)..' Msg', callback_data = chat..'_MSG_MAX'}
                  ...
                  {text = '🔙 بازگشت به صفحه اول', callback_data = 'left_page:'..chat},{text = '🌀 بازگشت به منوی اصلی 🔙', callback_data = 'firstmenu:'..chat}
                }
              }
              edit(q.inline_message_id,'_⚙️ تنظیمات ⚙️_\n`صفحه دوم 2️⃣`\n',keyboard)
            end
